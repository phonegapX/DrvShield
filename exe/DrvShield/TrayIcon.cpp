...
{ 
//	MessageBox(NULL,"CTrayIcon::ShowBalloonTip::::LPCTSTR szMsg","ShowBalloonTip",MB_OK);

	BOOL ret;
	m_nid.cbSize=sizeof(NOTIFYICONDATA);

/*下面这句的Flags要传对，原来只传的是一个NIF_INFO*/
	...
	ret = Shell_NotifyIcon(NIM_MODIFY, &m_nid);
	return ret;
}
...
BOOL CTrayIcon::ShowBalloonTip(UINT uID, LPCTSTR szTitle,
	UINT uTimeout, DWORD dwInfoFlags)
{
//	MessageBox(NULL,"UINT uID","ShowBalloonTip",MB_OK);
	CString s;
